        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Data Keluarga Baru</h5>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group"><div class="form-line">
                          ...
                          <input readonly class="form-control" type="text" name="np" value="<?php echo end($nomorkeluargaterakhir)['np']+1; ?>">
                        </div></div>
                        <div class="form-group"><div class="form-line">
                          <label for="kepalakeluarga">Nama Kepala Keluarga</label>
                          <input class="form-control" type="text" name="kepalakeluarga" value="<?php echo set_value('kepalakeluarga'); ?>">
                        </div></div>
                        <div class="form-group"><div class="form-line">
                      ...
                      <div class="col-md-6">
                        ...
                        <div class="form-group"><div class="form-line">
                          ...
                          <input class="form-control tanggal-menikah" type="text" placeholder="Select a Date" name="tglnikah" value="<?php echo set_value('tglnikah'); ?>">
                        </div></div>
                        <div class="form-group"><div class="form-line">
                        ...
                        <div class="form-group"><div class="form-line">
                          ...
                          echo form_dropdown('statusekonomi', $ekonomi, null, $statusekonomi_attribute);
                          ?>
                        </div></div>
                      </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <input type="submit" name="tambah-keluarga" value="Simpan" class="btn btn-primary">
                </div>
                <?php echo form_close(); ?>
            </div>
        </div>

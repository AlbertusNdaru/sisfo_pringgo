...
<?php foreach ($daftaradmin as $admin) { ?>
    <div class="modal fade" id="perbaruiadmin-<?php echo $admin['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Perbarui Data Admin <?php echo $admin['username']; ?></h5>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group"><div class="form-line">
                          ...
                          <input class="form-control" type="text" name="namalengkap" value="<?php echo set_value('namalengkap', $admin['namalengkap']); ?>">
                        </div></div>
                        <div class="form-group"><div class="form-line">
